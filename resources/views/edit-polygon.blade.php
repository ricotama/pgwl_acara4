        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Edit Polygone</h1>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="name" name="name"
                                placeholder="Fill polygone name" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" id="image_polygone" name="image"
                                onchange="document.getElementById('preview-image-polygone').src = window.URL.
    ...
    <script>
        ...
        map.on('draw:edited', function(e) {
            ...
            layers.eachLayer(function(layer) {
                ...
                $('#preview-image-polygone').attr('src', "{{ asset('storage/images') }}/" + properties.image);
        ...
        var polygon = L.geoJson(null, {
            onEachFeature: function(feature, layer) {
                ...
                //Memasukkan layer polygone ke dalam drawnItems
                drawnItems.addLayer(layer);
                ...
                layer.on({
                    click: function(e) {
                        ...
                        $('#description').val(properties.description);
                        $('#geom_polygons').val(objectGeometry);
                        $('#preview-image-polygone').attr('src', "{{ asset('storage/images') }}/" +
                            properties.image);
